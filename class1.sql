# Show how many databases are there in the system
show databases;  

# Create a new database
create database class;

# It will not create new database if database already exist
...
#to use reserved keywords we use ` ` character
...
# Show how many rows or records in the table
...
Q1:- Find out sum of balance  
select sum(balance) from bank;

Q2:- Find out avarage of balance 
select avg(balance) from bank;

Q3:- Find out who is having a min balance 
select  min(balance) from bank;
select * from bank order by balance;

Q4:- Find out who is having a mazxmim balance 
...
select * from bank where balance = (select min(balance) minimum_balance from bank)    # minimum balance is a aliasing

Q5:- Prepare a list of all the person who is having loan 
select * from bank where loan = 'yes'

Q6:- Find out average balance for all the people whose job role is admin 
select avg(balance) from bank where job = 'admin.'

Q7:- Find out a record  without job whose age is below 45 
select * from bank where job = 'unknown' and age < 45;

Q8:- Find of a record whose bank account is having a negative balance 
select * from bank where balance < 0;

Q9:- Find out a record who is not having house at all along with there balance
select balance, housing from bank where housing  = 'no';